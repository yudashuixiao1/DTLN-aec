...
class DTLN_model():
    ...
    def __init__(self):
        ...
        self.model = '/home/ljl/projects/DTLN/DTLN-aec_v2/models_DTLN_aec_v2_s_512_norm/DTLN_aec_v2_s_512_norm.h5' #[]
    ...
    def build_DTLN_model(self, norm_stft=False):
        ...
        # calculate STFT
        farend_mag,farend_angle = Lambda(self.stftLayer)(farend_dat)
        nearend_mag,nearend_angle = Lambda(self.stftLayer)(nearend_dat)
